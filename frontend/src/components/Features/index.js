                    ...
                    <div className="feature1Container">
                        ...
                        <div className="feature1Body">
                            ...
                            <div className="feature1Text">
                                <p>It's okay to have favorites! Post what dishes you absolutely loved so everyone else can try.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="feature2Container">
                        ...
                        <div className="feature2Body">
                            ...
                            <div className="feature2Text">
                                <p>Try new dishes from other Saseeme users and let them know what you thought about it!</p>
                            </div>
                        </div>
                    </div>
                </div>
